...
Created to work only in Cloud environments 

DevOps

A collaborative approach that allows the following teams to collaborate:

Business Owners, Development, operations, Quality Assurance 

Agile and lean thinking principles to all stakeholders. DevOps improves productivity through accelerating feedback cycles. 
