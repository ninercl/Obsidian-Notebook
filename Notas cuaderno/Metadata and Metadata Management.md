...
Users who want to explore and analyze data within and outside the enterprise are typically interested in _data discovery_. They need to be able to find data which is meaningful and valuable to them and know where that data can be accessed from. These business-minded users are thus interested in business metadata, which is information about the data described in readily interpretable ways, such as:
...
- **Develop and administer policies and processes** to ensure information can be accessed, integrated from various sources, and appropriately shared across the enterprise.
    
- **Data Catalog:** A critical component, creating a reliable, user-friendly, web-based interface for organizing and searching key attributes (e.g., CustomerName, ProductType). This catalog is central to Data Governance, allowing companies to inventory and efficiently organize their data systems.
...
- Tracks origin, transformation, and movement of data.
    
- Helps trace data errors to their root cause.
...
1. **Availability:** Data is accessible as needed.
    
2. **Usability:** Data can be effectively used.
    
3. **Consistency:** Data remains consistent.
    
4. **Data Integrity:** Maintains data accuracy.
    
5. **Data Security:** Protects data from unauthorized access.
...
- Accountability for poor data quality.
