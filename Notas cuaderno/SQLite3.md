...
3. `import sqlite3`
4. `sql_connection = sqlite3.connect(‘database.db’)`
...
2. `df.to_sql(table_name, sql_connection, if_exists = 'replace', index = False)`
...
2. `df = pandas.read_sql(query_statement, sql_connection)`
